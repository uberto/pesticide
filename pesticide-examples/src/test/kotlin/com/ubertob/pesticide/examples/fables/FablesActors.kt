...
data class Human(override val name: String) : DdtUserWithContext<FablesInterpreter, String>() {
...
data class Wolf(override val name: String) : DdtUserWithContext<FablesInterpreter, String>() {
